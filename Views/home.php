<header class="py-5 text-center gradient-bg-3 container-fluid texto-sombra">
  ...
  <div class="mt-4">
    ...
    <a href="https://github.com/seu-usuario/filid-mvc" class="btn btn-outline-light btn-lg px-4"
      target="_blank">
    ...
    <div class="col-md-9">
      ...
      <section id="requisitos" class="py-3">
        ...
        <ul class="list-group mb-4">
          ...
          <li class="list-group-item">Composer (opcional)</li>
        </ul>
      </section>
      ...
      <section id="instalacao" class="py-3">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <pre class="mb-3"><code>cp .env.txt .env</code></pre>
      ...
      <section id="uso" class="py-3">
        ...
        <h4 class="mt-4">Definindo Rotas</h4>
        <p>Arquivo <code>Configs/routes.php</code>:</p>
        <pre>
          <code>
            &lt;?php
      ...
      <!-- Mensagem -->
      <section id="mensagem" class="py-3">
      ...
      <!-- Segurança -->
      <section id="seguranca" class="py-3">
